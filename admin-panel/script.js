...
async function handleLogin(event) {
    ...
    try {
        const response = await fetch('htpp://localhost:5000/login', {
            method: 'POST',
            headers: {
...
async function handleRegister(event) {
    ...
    try {
        const response = await fetch('htpp://localhost:5000/register', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
async function handleAddBlog(event) {
    ...
    try {
        const response = await fetch('htpp://localhost:5000/blog', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
